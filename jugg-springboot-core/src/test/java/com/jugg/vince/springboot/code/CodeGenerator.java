package com.jugg.vince.springboot.code;
...
import static com.jugg.vince.springboot.common.core.ProjectConstant.*;

/**
 * Author:   Vince
 * Date:     2018/7/24 下午11:03
 * Description:
 */
public class CodeGenerator {
    ...
    private static final String PROJECT_PATH = System.getProperty("user.dir") + "/jugg-springboot-core";
    ...
    private static final String PACKAGE_PATH_SERVICE_IMPL = packageConvertPath(SERVICE_IMPL_PACKAGE);//生成的ServiceImpl存放路径
    ...
    public static void genService(String tableName) {
        try {
            ...
            data.put("bizPackage", BIZ_PACKAGE);
